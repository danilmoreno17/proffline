...
public class CryptoUtils  {
	...
	public static void main(String[] args) {
		...
		System.out.println(Util.formatoDigitoDecimal("4538451.45"));
		
		try {
			System.out.println(encrypt("CSTI_FTP",new File("init.key")));
			System.out.println(decrypt("4095981BC7F79CE6F713DC65AB871CBC", new File("init.key")));
//			System.out.println(decrypt("C7E72EF86D69855539D97CD1F5E5D84C", new File("init.key")));
